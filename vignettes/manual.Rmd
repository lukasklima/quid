...
<a id="stringi"></a> Gagolewski, M. (2021). *stringi: Fast and portable character string processing in R*. R package version 1.6.2, \<URL: <https://stringi.gagolewski.com/>\>.
