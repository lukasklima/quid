...
#'  \item{error}{Numeric values indicating whether participant gave a wrong anser (all 0)}
...
#'  }
#' @source Data from Rouder et al. (2005), retrieved from \url{https://raw.githubusercontent.com/PerceptionCognitionLab/data0/master/lexDec-dist5/ld5.all}
#'
"ld5"
