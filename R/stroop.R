...
#'  }
#'
#' @source Data from Von Bastian et al. (2015), retrieved from \url{https://raw.githubusercontent.com/PerceptionCognitionLab/data0/master/contexteffects/FlankerStroopSimon/LEF_stroop.csv}
"stroop"
